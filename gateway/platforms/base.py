...
class BasePlatformAdapter(ABC):
    ...
    def extract_media(content: str) -> Tuple[List[Tuple[str, bool]], str]:
        ...
        #
        # Important: document attachments (for example .md, .txt, .pdf, .csv)
        # must also be recognized here so platform adapters like Telegram can
        # route them through send_document(). Keep this focused on absolute/home
        # paths to avoid false positives from arbitrary inline text.
